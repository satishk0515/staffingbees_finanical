/**
 * @file ApStatusTabs.jsx
 * @description Status tabs navigation bar for AP Bills list view:
 * All, Unpaid, Partial, Paid, and Overdue with live counts.
 *
 * Props:
 * @param {string} currentStatus - Active status tab ('all', 'unpaid', 'partial', 'paid', 'overdue')
 * @param {Function} onSelectStatus - Tab change callback
 * @param {Array<Object>} bills - Complete bills dataset for count computing
 */
