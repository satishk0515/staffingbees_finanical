/**
 * @file ApAgingChart.jsx
 * @description Stacked/Segmented bar chart visualizing Accounts Payable liabilities
 * across the 4 schedule urgency buckets: Overdue, Due This Week, Due Next Week, and Current.
 *
 * Props:
...
export function ApAgingChart({
  ...
  return (
    <ChartCard
      title="Accounts Payable (AP) Aging Distribution"
      subtitle={`Total Open Payables: ${formatCurrency(totalOutstanding)} across 4 schedule urgency buckets`}
      height="h-60"
    >
